...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GkeepApi.UserProfileListGeoLocalizationSettings();
  });
  ...
  describe('UserProfileListGeoLocalizationSettings', function() {
    it('should create an instance of UserProfileListGeoLocalizationSettings', function() {
      // uncomment below and update the code to test UserProfileListGeoLocalizationSettings
      //var instane = new GkeepApi.UserProfileListGeoLocalizationSettings();
      //expect(instance).to.be.a(GkeepApi.UserProfileListGeoLocalizationSettings);
    });
