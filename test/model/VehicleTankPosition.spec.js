...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GkeepApi.VehicleTankPosition();
  });
  ...
  describe('VehicleTankPosition', function() {
    it('should create an instance of VehicleTankPosition', function() {
      // uncomment below and update the code to test VehicleTankPosition
      //var instane = new GkeepApi.VehicleTankPosition();
      //expect(instance).to.be.a(GkeepApi.VehicleTankPosition);
    });
