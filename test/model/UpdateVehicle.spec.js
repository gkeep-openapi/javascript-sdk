...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GkeepApi.UpdateVehicle();
  });
  ...
  describe('UpdateVehicle', function() {
    it('should create an instance of UpdateVehicle', function() {
      // uncomment below and update the code to test UpdateVehicle
      //var instane = new GkeepApi.UpdateVehicle();
      //expect(instance).to.be.a(GkeepApi.UpdateVehicle);
    });
