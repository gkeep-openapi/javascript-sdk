...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GkeepApi.VehicleVersionListList();
  });
  ...
  describe('VehicleVersionListList', function() {
    it('should create an instance of VehicleVersionListList', function() {
      // uncomment below and update the code to test VehicleVersionListList
      //var instane = new GkeepApi.VehicleVersionListList();
      //expect(instance).to.be.a(GkeepApi.VehicleVersionListList);
    });
