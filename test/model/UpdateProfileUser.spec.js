...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GkeepApi.UpdateProfileUser();
  });
  ...
  describe('UpdateProfileUser', function() {
    it('should create an instance of UpdateProfileUser', function() {
      // uncomment below and update the code to test UpdateProfileUser
      //var instane = new GkeepApi.UpdateProfileUser();
      //expect(instance).to.be.a(GkeepApi.UpdateProfileUser);
    });
