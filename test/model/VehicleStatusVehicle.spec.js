...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GkeepApi.VehicleStatusVehicle();
  });
  ...
  describe('VehicleStatusVehicle', function() {
    it('should create an instance of VehicleStatusVehicle', function() {
      // uncomment below and update the code to test VehicleStatusVehicle
      //var instane = new GkeepApi.VehicleStatusVehicle();
      //expect(instance).to.be.a(GkeepApi.VehicleStatusVehicle);
    });
