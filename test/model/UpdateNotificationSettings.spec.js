...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GkeepApi.UpdateNotificationSettings();
  });
  ...
  describe('UpdateNotificationSettings', function() {
    it('should create an instance of UpdateNotificationSettings', function() {
      // uncomment below and update the code to test UpdateNotificationSettings
      //var instane = new GkeepApi.UpdateNotificationSettings();
      //expect(instance).to.be.a(GkeepApi.UpdateNotificationSettings);
    });
