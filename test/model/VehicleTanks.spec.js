...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GkeepApi.VehicleTanks();
  });
  ...
  describe('VehicleTanks', function() {
    it('should create an instance of VehicleTanks', function() {
      // uncomment below and update the code to test VehicleTanks
      //var instane = new GkeepApi.VehicleTanks();
      //expect(instance).to.be.a(GkeepApi.VehicleTanks);
    });
